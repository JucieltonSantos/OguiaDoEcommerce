<form name="form1" method="post" action="email_landing3.php" class='contact-form'>
  <table width="100" border="0" cellspacing="0" cellpadding="0" align="center">
    <tr class="name"> 
      <td valign="top" width="100" nowrap><font class="texto">Nome:</font></td>
      <td> 
        <input type="text" name="nome" size="34" style="color: black;">
      </td>
    </tr>
   <tr class="name"> 
      <td valign="top" width="100" nowrap><font class="texto">Sobrenome:</font></td>
      <td> 
        <input class="form_campos" type="text" name="sobrenome" size="20" style="color: black;">
      </td>
    </tr>
   <!-- <tr bgcolor="#F4F4F4"> 
    ...
    <tr class="email"> 
      ...
      <td> 
        <input type="text" name="email" size="34" style="color: black;">
      </td>
    </tr>
    <!--<tr bgcolor="#F4F4F4"> 
