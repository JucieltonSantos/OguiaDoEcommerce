...
if ($nome!="" and $email!="" and $sobrenome!="")
	...
	if (mail($mail_destino, "Formulário do SITE: $assunto", $msg, "From:$nome<$email>"))
		...
		echo 
			...
			echo '<a href="EBOOK_10_Vantagens_Em_Ter_Uma_Loja_Virtual.pdf" target="_blank"><font style="font-family: verdana; font-weight: 900; color:red; font-size: 40px;">Clique aqui para baixar o PDF.</font></a><br>';
